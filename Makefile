...
BUILD		:=	build
SOURCES		:=	source source source/Source source/Headers
INCLUDES	:=	include source source/Source source/Headers
DATA		:=	data  
GRAPHICS	:=	gfx 
AUDIO		:=	assets/audio
...
ifneq (,$(findstring $(TARGET).bmp,$(icons)))
	...
	ifneq (,$(findstring icon.bmp,$(icons)))
		export GAME_ICON := $(CURDIR)/crabicon.bmp
	endif
endif
...
#---------------------------------------------------------------------------------
	@mmutil $^ -d -osoundbank.bin -hsoundbank.h -d
